  ...
  const fetchTopRatedBusinesses = async () => {
    try {
      ...
      setBusinesses([
        {
          id: "1",
          name: "Elite Dining Experience",
          category: "Restaurants",
          rating: 4.9,
          reviewCount: 1247,
          address: "123 Prestige Ave, Downtown",
          phone: "+1 (555) 123-4567",
          image: "https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=400&h=300&fit=crop",
          isOpen: true,
          distance: "2.1 km",
          tags: ["Fine Dining", "Michelin Star", "Romantic"],
          verified: true
        },
        {
          id: "2",
          ...
          isOpen: true,
          distance: "1.8 km",
          tags: ["Personal Training", "Luxury", "24/7"],
          verified: true
        },
        {
          id: "3",
          ...
          rating: 4.9,
          reviewCount: 654,
          address: "789 Serenity Lane, Uptown",
        ...
        },
        {
          ...
          rating: 4.7,
          reviewCount: 445,
          address: "321 Brew St, Arts District",
          phone: "+1 (555) 111-2222",
          image: "https://images.unsplash.com/photo-1501339847302-ac426a4a7cbb?w=400&h=300&fit=crop",
          isOpen: true,
          distance: "0.9 km",
          tags: ["Artisanal", "WiFi", "Pet Friendly"],
          verified: true
        },
        {
          id: "5",
          ...
          rating: 4.8,
          reviewCount: 567,
          address: "654 Innovation Dr, Tech Park",
          phone: "+1 (555) 333-4444",
          image: "https://images.unsplash.com/photo-1497366216548-37526070297c?w=400&h=300&fit=crop",
          isOpen: true,
          distance: "4.1 km",
          tags: ["Coworking", "High-Speed", "Events"],
          verified: true
        },
        {
          id: "6",
          name: "Boutique Fashion House",
          category: "Shopping",
          rating: 4.6,
          reviewCount: 723,
          address: "987 Style Ave, Fashion District",
          phone: "+1 (555) 555-6666",
          image: "https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=400&h=300&fit=crop",
          isOpen: false,
          distance: "2.7 km",
          tags: ["Designer", "Boutique", "Vintage"],
          verified: true
        }
      ]);
    } finally {
